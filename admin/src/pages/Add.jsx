  ...
  return (
    ...
    <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
            ...
            <input onChange={(e)=> setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='Set Price'/>
        </div>
    ...
    <button type="submit" className='w-28 py-3 mt-4 bg-black text-white border border-gray-300 rounded'>Submit / Add</button>
